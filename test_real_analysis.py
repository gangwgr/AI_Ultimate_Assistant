...
def test_real_analysis():
    """Test the improved analysis with real API token"""
    ...
    print("🔧 Step 1: Configuring Report Portal with real token...")
    try:
    ...
    # Test analysis with 24 hours and API component
    analysis_request = {
        "hours_back": 24,
        "components": ["API"],
    ...
    print("\n🔍 Step 2: Testing Real Analysis (24 hours, API component)...")
    print("   This should handle the 1615 tests efficiently with batch processing")
